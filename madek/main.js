...
module.exports = __webpack_require__(/*! /Users/oleksiida/projects/RCM-Lovato/git/new-madek/src/main.ts */"zUnb");
...
class HttpService {
    ...
    sendButtonAction(action, button) {
        ...
        return this.httpClient.post(`${this.backendUrl}/hardsocket`, this.getPostBody(send));
    }
    getPostBody(actions) {
    ...
    getAllData() {
        ...
        this.httpClient.post(`${this.backendUrl}/hardsocket`, this.getPostBody(allkeys))
            ...
            //   let x = {
            //     result: {
            //       '0103006500019415': 6656,
            //       '010300c900015434': 258,
            //       '0103032300017584': 65535,
            //       '010300c7000135f7': 1810,
            //       '010300c8000105f4': 9332,
            //       '010300ca0001a434': 9792,
            //       '0103012c0001443f': 1,
            //       '0103041c000144fc': 3,
            //       '010300cb0002b5f5': '9807',
            //       '0103006300017414': '230.s',
            //       '010300640001c5d5': '31',
            //       '0103006f0001b417': '30',
            //       '0103006e0001e5d7': '30',
            //       '0103008f0002f5e0': '2570',
            //       '01030089000215e1': '2000007537',
            //       '0103006900021417': 'sdf',
            //     }
            //   };
...
/* harmony import */ var _bottom_wrapper_bottom_wrapper_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./bottom-wrapper/bottom-wrapper.component */ "Y/mX");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 12, vars: 3, consts: [[4, "ngIf"], [1, "flex-col"], [1, "flex-row"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _connection_parameters_connection_parameters_component__WEBPACK_IMPORTED_MODULE_3__["ConnectionParametersComponent"], _main_board_main_board_component__WEBPACK_IMPORTED_MODULE_4__["MainBoardComponent"], _motor_board_motor_board_component__WEBPACK_IMPORTED_MODULE_5__["MotorBoardComponent"], _bottom_wrapper_bottom_wrapper_component__WEBPACK_IMPORTED_MODULE_6__["BottomWrapperComponent"], _shared_components_loading_loading_component__WEBPACK_IMPORTED_MODULE_7__["LoadingComponent"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["AsyncPipe"]], styles: [""] });
...
/***/ "Y/mX":
/*!************************************************************!*\
  !*** ./src/app/bottom-wrapper/bottom-wrapper.component.ts ***!
  \************************************************************/
...
class BottomWrapperComponent {
    ...
    ngOnInit() {
        this.modelService.generatorStatus$.subscribe(status => {
            ...
            this.r0089 = +status['0089'] - 2000000000;
            this.r0069 = +status['0069'] - 2000000000;
            if (this.r0089 < 0) {
                this.r0089 = 0;
            }
            if (this.r0069 < 0) {
...
/* harmony import */ var _bottom_wrapper_bottom_wrapper_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./bottom-wrapper/bottom-wrapper.component */ "Y/mX");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        ...
        _bottom_wrapper_bottom_wrapper_component__WEBPACK_IMPORTED_MODULE_12__["BottomWrapperComponent"],
...
class ModelService {
    ...
    parseResponse(response) {
        ...
        this.r0323$.next(this.checkValue(res['0103032300017584']));
        this.r00cb$.next(this.checkValue(res['010300cb0002b5f5']));
        this.r012C$.next(this.checkValue(res['0103012c0001443f']));
        this.r041c$.next(this.checkValue(res['0103041c000144fc']));
        this.r00C9$.next(this.checkValue(res['010300c900015434']));
        this.r00C7$.next(this.checkValue(res['010300c7000135f7']));
        this.r00CA$.next(this.checkValue(res['010300ca0001a434']));
        this.r0065$.next(this.checkValue(res['0103006500019415']));
        this.r00C8$.next(this.checkValue(res['010300c8000105f4']));
        this.generatorStatus$.next({
            '0063': this.checkValue(res['0103006300017414']),
            '0064': this.checkValue(res['010300640001c5d5']),
            '006f': this.checkValue(res['0103006f0001b417']),
            '006e': this.checkValue(res['0103006e0001e5d7']),
            '008F': this.checkValue(res['0103008f0002f5e0']),
            '0089': this.checkValue(res['01030089000215e1']),
            '0069': this.checkValue(res['0103006900021417']),
        });
    }
    checkValue(value) {
