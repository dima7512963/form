(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/oleksiida/projects/RCM-Lovato/git/new-telys/src/main.ts */
      "zUnb");
      /***/
    },
        ...
        _createClass(EngineStatusComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.modelService.speeds$.subscribe(function (status) {
              _this.s1 = +status['s1'] / 100;
              _this.s2 = +status['s2'] / 100;
              _this.s3 = +status['s3'] / 100;
              _this.s4 = +status['s4'] / 100;
              _this.s5 = +status['s5'] / 100;
              _this.s6 = +status['s6'] / 100;
              _this.s7 = +status['s7'] / 10;
              _this.s8 = +status['s8'];
              _this.s9 = +status['s9'];
              _this.s10 = +status['s10'];
              _this.s11 = +status['s11'] / 1000;
            });
          }
        }]);
      ...
      var HttpService = /*#__PURE__*/function () {
        function HttpService(httpClient, modelService, route) {
          ...
          this.httpClient.get('assets/config.json').subscribe(function (config) {
            _this2.backendUrl = config.backendUrl || 'http://127.0.0.1:9092';
        ...
        _createClass(HttpService, [{
          ...
          value: function sendButtonAction(action, button) {
            ...
            return this.httpClient.post("".concat(this.backendUrl, "/socket"), this.getPostBody(action));
          }
        }, {
          key: "getPostBody",
          value: function getPostBody(action) {
            return {
          ...
          value: function getAllData() {
            ...
            var allkeys = ['020300510001d5e8', '0203003d000115f5', '0203005e0001e5eb', '0203003b0001f5f4', '0203003f0001b435', '02030043000175ed', '020300c8000105c7', '020300420001242d', '02030032000125f6', '0203003300017436', '020300340001c5f7', '0203003500019437', '0203003600016437', '02030037000135f7', '0203003c00014435', '02030038000105f4', '0203003900015434', '0203003a0001a434', '0203003b0001f5f4'];
            this.httpClient.post("".concat(this.backendUrl, "/hardsocket"), this.getPostBody(allkeys)).subscribe(function (response) {
              if (_this3.enableLog) {
    ...
    function RoBY(module, __webpack_exports__, __webpack_require__) {
        ...
        _createClass(MotorBoardComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.modelService.batV$.subscribe(function (status) {
              return _this4.batV = +status / 1000;
            });
            this.modelService.oilP$.subscribe(function (status) {
              return _this4.oilP = +status;
            });
            this.modelService.engRPM$.subscribe(function (status) {
              return _this4.engRPM = +status;
            });
            this.modelService.fuelLvl$.subscribe(function (status) {
              return _this4.fuelLvl = +status;
            });
            this.modelService.engOpHours$.subscribe(function (status) {
              return _this4.engOpHours = +status;
            });
            this.modelService.engWorkTime$.subscribe(function (status) {
              return _this4.engWorkTime = +status;
            });
            this.modelService.controlPanel$.subscribe(function (status) {
              return _this4.controlPanel = +status;
            });
            this.modelService.waterC$.subscribe(function (status) {
              _this4.waterC = +status;
              _this4.waterCText = [].concat(_toConsumableArray(status.toString()), ['C']).join(' ');
            });
          }
        }]);
      ...
      MotorBoardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 32,
        vars: 16,
        consts: [[1, "board"], [1, "flex-row", "m-top-7"], [1, "flex-col", "left"], [1, "wrap", "p5"], [3, "value", "max", "label"], [1, "flex-col", "right"], [1, "flex-row"], [1, "term", "wrap", "m-left-10"], [1, "title"], ["type", "text", 1, "parameter-value", "digital-input", 3, "value", "valueChange"], [3, "value"], [1, "fuel", "wrap", "m-left-10"], [3, "value", "max"], [1, "fex-row", "m-top-10", "m-left-10"], [1, "e-status", "wrap"], [1, "flex-row", "m-top-15"], [1, "e-status", "wrap", 2, "margin-left", "18px"]],
        template: function MotorBoardComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("valueChange", function MotorBoardComponent_Template_input_valueChange_22_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("valueChange", function MotorBoardComponent_Template_input_valueChange_31_listener($event) {
              return ctx.engWorkTime = $event;
            });
    ...
    function uP7T(module, __webpack_exports__, __webpack_require__) {
      ...
      var MainBoardComponent = /*#__PURE__*/function () {
        function MainBoardComponent(httpService, modelService) {
          ...
          this.modelService.speeds$.subscribe(function (status) {
            _this6.lamp.l1 = +status['s4'] > 0;
            _this6.lamp.l2 = +status['s5'] > 0;
            _this6.lamp.l3 = +status['s6'] > 0;
          });
          this.modelService.controlPanel$.subscribe(function (status) {
            _this6.isActive.auto = false;
            _this6.isActive.test = false;
      ...
      MainBoardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function MainBoardComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MainBoardComponent_Template_div_click_31_listener() {
